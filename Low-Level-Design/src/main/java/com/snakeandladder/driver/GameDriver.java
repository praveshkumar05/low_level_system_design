package com.snakeandladder.driver;
...
public class GameDriver {
        ...
        // Create a Scanner object for taking input from the console
        ...
        for (int i = 0; i < numberOfSnakes; i++) {
                ...
                int tailPostion = scanner.nextInt();
                board.addSnake(headPosition, tailPostion);
        ...
        for (int i = 0; i < numberOfLadders; i++) {
                ...
                board.addLadder(startPosition, endPosition);
        ...
        int boardSize = 100;
        GameService game = new GameService(board, players,boardSize);
